...
// In dev, Vite proxy handles /api/ndbc; in production, Firebase Hosting rewrites to apiProxy Cloud Function (NDBC blocks CORS).
...
// In dev, Vite proxy; in production, Firebase Hosting rewrites /api/nhc to apiProxy Cloud Function.
